...
export default function Index() {
  ...
  return (
    <div className="h-full w-full">
      ...
      <main>
        <div className="font-sans p-4 grid grid-cols-1 grid-rows-1 md:grid-cols-[300px,1fr]">
            ...
            <div className="flex justify-between py-4">
              ...
              <div className="flex flex-nowrap gap-4">
                {loaderData.data.previous ? (
                  <Link
                    to={`${location.pathname}?${updateSearchParams(
                      location.search,
                      {
          ...
          <div
            className={twJoin(
              "bg-white md:row-start-1 md:col-start-2",
